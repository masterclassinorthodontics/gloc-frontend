        ...
        <div className="mb-8">
          ...
          <div className="text-[#36384F] text-lg md:text-[15px] leading-relaxed text-justify">
            <p>
              ...
              equipment, superior quality and the finest treatment available,
              we promises you to deliver a truly world-class dental experience.
            </p>

            <br />

            <p>
              Centred in <b>South Kolkata</b>, this clinic is a centre of
              excellence in the field of dentistry with a mission to offer a
              whole gamut of dental services at an affordable price tag, while
              laying special emphasis on convenience and customer satisfaction.
            </p>

            <br />

            <p>
              Brainchild of a few outstanding entrepreneurs and professionals,
              this centre was incepted with the sole purpose of making
              international dental care affordable for the people of Kolkata.
            </p>

            <br />

            <p>
              In addition, the centre is associated with some of the biggest
              names in the Indian and international dental world.
            </p>

            <br />

            <p>
              The Panel of its "Signature Clinic" has specialists from every
              branch of dentistry with special focus on orthodontics
              (Treatment with Braces). Moreover, their resident panel has a
              Periodontist, a Prosthodontist and a general practitioner.
            </p>

            <br />

            <p>
              The company's vision is to become one of the most progressive,
              innovative and forward-thinking dental clinics in the city.
              In short, we are here to make you smile!
            </p>
          </div>
        </div>
