export default function BestInvisalignWhyChooseUsSection() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-[#36384F] text-[15px] leading-relaxed text-justify mb-10">
              ...
              <strong>orthodontic treatment</strong> and <strong>clear orthodontics braces, </strong>
            ...
            <p className="text-[#36384F] text-[15px] leading-relaxed text-justify">
              Every orthodontic treatment depends on age, condition, and personalized problem in the patient. We first give the proper guidance and consultation to the patient before planning <strong>invisible removable or transparent braces</strong>. You shall decide on the treatment after you have a word about the same with the <strong>best cosmetic dentist in Kolkata</strong>.
            </p>
